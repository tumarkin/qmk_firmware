...
#define PROG_TOG TG(_PROGRAMMER)
#define TENKEY_M MO(_TENKEY)
 ...
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * | Ctrl | Alt  | GUI  |Numerc|Lower |    Space    |Raise | Left | Down |  Up  |Right |
 * `-----------------------------------------------------------------------------------'
 */
// KC_DEL: DEL
// BACKLIT: Brite
...
[_QWERTY] = LAYOUT_preonic_grid(
  ...
  KC_LCTL,  KC_LALT, PROG_TOG , TENKEY_M, LOWER,   KC_SPC, KC_SPC, RAISE,   KC_LEFT, KC_DOWN, KC_UP,      KC_RGHT
),
 ...
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * | CTRL | ALT  | GUI  | ESC  |Lower |    Space    |Raise | Left | Down |  Up  |Right |
 * `-----------------------------------------------------------------------------------'
 */
// KC_DEL: DEL
[_BEAKL15] = LAYOUT_preonic_grid(
  ...
  KC_LCTL,  KC_LALT,  KC_LGUI, KC_ESC,    LOWER,     KC_SPC,    KC_SPC,    RAISE,     KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT
),
