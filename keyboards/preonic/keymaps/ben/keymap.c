...
#define QWRT_Q LCTL_T(KC_Q)
#define QWRT_W LALT_T(KC_W)
#define QWRT_E LGUI_T(KC_E)
#define QWRT_R LSFT_T(KC_R)
// Right-hand home row mods
#define QWRT_U RSFT_T(KC_U)
#define QWRT_I RGUI_T(KC_I)
#define QWRT_O LALT_T(KC_O)
#define QWRT_P RCTL_T(KC_P)
// // 10 key toggles
...
[_QWERTY] = LAYOUT_preonic_grid(
  ...
  KC_TAB,  QWRT_Q,    QWRT_W,    QWRT_E,    QWRT_R, KC_T,   KC_Y,   QWRT_U,   QWRT_I,    QWRT_O,    QWRT_P,    KC_QUOT, 
  ESC_MO,  KC_A,      KC_S,      KC_D,      KC_F,   KC_G,   KC_H,   KC_J,     KC_K,      KC_L,      KC_SCLN,   KC_ENT,
